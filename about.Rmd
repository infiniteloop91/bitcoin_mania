...
library(ggplot2)
library(plotly)
google_data <- read.csv("/Users/ERIC/Desktop/BDS_522/Stock_Search_data.csv", sep = ',')
stock_data <- read.csv("/Users/ERIC/Desktop/BDS_522/TRADING_VOLUME.csv", header = TRUE, sep = ',')
bitcoin_data <- read.csv("/Users/ERIC/Desktop/BDS_522/bitcoin_multiTimeline.csv", header = TRUE, sep = ',')
bitcoin_price <- read.csv("/Users/ERIC/Desktop/BDS_522/coindesk-bpi-USD-close_data-2010-07-17_2018-10-09.csv", header = TRUE, sep = ',')
bitcoin_trades <- read.csv("/Users/ERIC/Desktop/BDS_522/bitcoinity_data.csv", header = TRUE, sep = ',')
gdp_data <- read.csv("/Users/ERIC/Desktop/BDS_522/GDP_DATA.csv", header = TRUE, sep = ',')
```
